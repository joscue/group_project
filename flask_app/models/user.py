...
class User:
    ...
    @classmethod 
    def get_url_by_keyword(cls, data:str) -> str:
        query = "SELECT idkeyword_url FROM keyword_url WHERE keyword = %(keyword)s;"
        result = connectToMySQL(DATABASE).query_db(query,{'keyword':data})
        return (result)
